...
gulp.task("watch-css", function () {
    gulp.watch(PATH_FOLDER_SCSS, cssCompilation);
});
...
gulp.task("css", cssCompilation);
gulp.task("js-min", jsCompilation);
gulp.task(
    "watch",
    gulp.parallel("watch-css", "watch-scss", "watch-js", "browser-sync")
);
gulp.task(
    "default",
    gulp.parallel("html-min", "scss", "js-min", "webp", "css")
);
